...
<body>
	...
	<div class="login">
		<form:form action="proceedUpdate" method="post">
			<div class="login-screen">
				<div class="login-form">
					<div class="app-title">
						<h2 style="text-align:center; padding-bottom: 20px;">Update Reservation</h2>
					</div>
					<div class="control-group">
						<label class="login-label">Departure Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label class="login-label">Return Date</label><br /> 
						<input type="date" name="departureDate" class="login-field" value="${reservations.departureDate}" required>
						<input type="date" name="returnDate" class="login-field" value="${reservations.returnDate}" required>
					</div>
					<br />
					...
					<div class="control-group">
						<label class="login-label" for="login-name">Number of Nights&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label class="login-label" for="login-name">Number of Rooms</label><br /> 
						<input type="number" name="noOfNights" class="login-field" min="1" placeholder="1" value="${reservations.noOfNights}"required> 
						<input type="number" name="noOfRooms" class="login-field" min="1" placeholder="1" value="${reservations.noOfRooms}" required>
					</div>
					<br />
	...
	<br />
	<footer>
		&copy;2021 FreeLancing - Java EE Programming <br />All Rights
		Reserved
	</footer>
</body>
</html>